...
export default function DatePicker({ from, to, onChange, compFrom, compTo, onCompChange, showComp = true }) {
  ...
  const PRESETS = [
    ...
    { label: 'Last 60 days',  fn: () => preset(subDays(new Date(),59), new Date()) },
    { label: 'Last 90 days',  fn: () => preset(subDays(new Date(),89), new Date()) },
    { label: 'Last 180 days', fn: () => preset(subDays(new Date(),179), new Date()) },
