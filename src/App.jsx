    ...
    <aside style={{
      ...
      <div style={{ padding: '20px 16px 16px', borderBottom: '0.5px solid var(--border)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: 15, fontWeight: 700, letterSpacing: '-0.01em' }}>BlissClub</div>
            <div style={{ fontSize: 10, color: 'var(--text3)', marginTop: 1 }}>Performance dashboard</div>
          </div>
        </div>
      </div>
        ...
        {groups.map(group => (
          <div key={group} style={{ marginBottom: 4 }}>
            <div style={{
              ...
              color: group === 'Meta' ? 'var(--pink)' : group === 'Google' ? 'var(--blue)' : 'var(--text3)',
            }}>
              {group === 'Meta' ? '● ' : group === 'Google' ? '● ' : ''}{group}
            </div>
      ...
      {/* Status */}
      <div style={{ padding: '12px 16px', borderTop: '0.5px solid var(--border)', fontSize: 11 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
          <div style={{ width: 7, height: 7, borderRadius: '50%', background: hasData ? 'var(--green)' : 'var(--text3)' }} />
          <span style={{ color: hasData ? 'var(--green)' : 'var(--text3)', fontWeight: 500 }}>
